...
class OfficeAgent:
    def __init__(self, config: Dict = None):
        ...
        self.model_name = self.config.get("agent_model", "gpt-4")
        self.llm = ChatOpenAI(model=self.model_name, temperature=0.7)
        
        self.intent_recognizer = IntentRecognizer(model_name=self.model_name)
        self.memory_manager = MemoryManager(self.config.get("redis_url", "redis://localhost:6379"))
    ...
    def _extract_params(self, user_input: str, entities: Dict, tool_name: str) -> Dict:
        ...
        if tool_name == "send_email":
            ...
            params["start_time"] = entities.get("start_time", "")
            params["end_time"] = entities.get("end_time", "")
            params["attendees"] = entities.get("attendees", [])
            ...
            params["title"] = entities.get("title", "")
            params["output_path"] = entities.get("output_path", "")
            ...
            params["data"] = entities.get("data", {})
            params["title"] = entities.get("title", "")
            params["x_label"] = entities.get("x_label", "")
            params["y_label"] = entities.get("y_label", "")
            ...
            params["expression"] = entities.get("expression", user_input)
